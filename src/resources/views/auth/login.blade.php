    ...
    <div class="login-form__inner">
        ...
        <form class="login-form__form" action="{{ route('login') }}" method="POST" novalidate>
            ...
            <div class="login-form__group">
                <label class="login-form__label" for="email"><img src="{{ asset('images/icon/email.png') }}" alt="Email Icon" class="icon"></label>
            ...
            {{-- パスワード入力 --}}
            <div class="login-form__group">
                <label class="login-form__label" for="password"><img src="{{ asset('images/icon/password.png') }}" alt="Password Icon" class="icon"></label>
                <div class="login-form__field">
