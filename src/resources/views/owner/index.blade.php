        ...
        <div class="owner-home__container">
            ...
            <div class="shop-info">
                ...
                <div class="shop-info__section">
                    {{-- 店舗作成・更新フォーム --}}
                    <form method="POST"
                        action="{{ isset($shop) ? route('owner.shop.update', $shop->id) : route('owner.shop.store') }}"
                        ...
                        <div class="shop-info__form">
                            ...
                            <div class="shop-info__form-group">
                                ...
                                <input type="text" name="name" id="name"
                                    value="{{ old('name', $shop->name ?? '') }}" class="shop-info__form--input">
                            </div>
                            @error('name')
                            ...
                            <div class="shop-info__form-group">
                                ...
                                <div class="shop-info__img">
                                    <img id="preview-img" src="{{ $imageUrl ?: '#' }}" alt="Shop Image"
